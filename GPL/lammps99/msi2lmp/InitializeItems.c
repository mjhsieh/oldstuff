...
{
   /* ATOM TYPES */
   strcpy(atom_types.keyword, "#atom_types");
   atom_types.number_of_members = 1;
   atom_types.number_of_parameters = 1;
   ...
   if (forcefield == 1) return; /* Do not try to read cross terms for
                                   Class I forcefield */
