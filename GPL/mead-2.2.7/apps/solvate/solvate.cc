...
$Id: solvate.cc,v 2.13 2004/11/15 05:30:23 bashford Exp $
*/
#include <iostream>
using std::cout;
using std::cerr;
...
*/
  ...
  ChargeDist rho(new AtomChargeSet(a));

  DielectricEnvironment eps(new TwoValueDielectricByAtoms(a, epsin));

  ElectrolyteEnvironment ely(new ElectrolyteByAtoms(a));
  ...
  DielectricEnvironment vac_eps(new TwoValueDielectricByAtoms(a, epsin));
