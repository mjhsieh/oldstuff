...
C   (which is a coordinate fragment of .smol file)      
C   with 2,3,4 columns of the second file
C   (which is supposed to be optimized coordinates of the same molecule)      
C   This may be useful to rewtite optimized coordinates in .smol file
C
